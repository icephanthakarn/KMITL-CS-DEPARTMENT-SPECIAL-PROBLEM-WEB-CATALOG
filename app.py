...
def fill_project_info():
    ...
    if faculty != 'วิทยาศาสตร์':
        faculty_error = "คุณหมายถึง 'วิทยาศาสตร์' ใช่หรือไม่"
    ...
    if department_error or faculty_error:
    ...
    if replace_proj_id:
        ...
        project.updated_by = user_info['student_id']  
...
def is_admin():
    ...
    if not user_session:
        return False
    user_in_db = UserModel.query.get(user_session['student_id'])  
